...
_CoreRobotics.CR_SIGNAL_FORCE_swigconstant(_CoreRobotics)
CR_SIGNAL_FORCE = _CoreRobotics.CR_SIGNAL_FORCE

_CoreRobotics.CR_SIGNAL_POSITION_swigconstant(_CoreRobotics)
CR_SIGNAL_POSITION = _CoreRobotics.CR_SIGNAL_POSITION

_CoreRobotics.CR_SIGNAL_VELOCITY_swigconstant(_CoreRobotics)
CR_SIGNAL_VELOCITY = _CoreRobotics.CR_SIGNAL_VELOCITY

_CoreRobotics.CR_SIGNAL_ACCELERATION_swigconstant(_CoreRobotics)
CR_SIGNAL_ACCELERATION = _CoreRobotics.CR_SIGNAL_ACCELERATION

_CoreRobotics.CR_SIGNAL_GENERIC_swigconstant(_CoreRobotics)
CR_SIGNAL_GENERIC = _CoreRobotics.CR_SIGNAL_GENERIC

_CoreRobotics.CR_RESULT_SUCCESS_swigconstant(_CoreRobotics)
CR_RESULT_SUCCESS = _CoreRobotics.CR_RESULT_SUCCESS

_CoreRobotics.CR_RESULT_SINGULAR_swigconstant(_CoreRobotics)
CR_RESULT_SINGULAR = _CoreRobotics.CR_RESULT_SINGULAR

_CoreRobotics.CR_RESULT_UNWRITABLE_swigconstant(_CoreRobotics)
...
class CRMath(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["deg2rad"] = lambda x: _CoreRobotics.CRMath_deg2rad
    if _newclass:
        deg2rad = staticmethod(_CoreRobotics.CRMath_deg2rad)
    __swig_getmethods__["rad2deg"] = lambda x: _CoreRobotics.CRMath_rad2deg
    if _newclass:
        rad2deg = staticmethod(_CoreRobotics.CRMath_rad2deg)
    __swig_getmethods__["svd"] = lambda x: _CoreRobotics.CRMath_svd
    if _newclass:
        svd = staticmethod(_CoreRobotics.CRMath_svd)
    __swig_getmethods__["svdInverse"] = lambda x: _CoreRobotics.CRMath_svdInverse
    if _newclass:
        svdInverse = staticmethod(_CoreRobotics.CRMath_svdInverse)
    __swig_getmethods__["rotAboutX"] = lambda x: _CoreRobotics.CRMath_rotAboutX
    if _newclass:
        rotAboutX = staticmethod(_CoreRobotics.CRMath_rotAboutX)
    __swig_getmethods__["rotAboutY"] = lambda x: _CoreRobotics.CRMath_rotAboutY
    if _newclass:
        rotAboutY = staticmethod(_CoreRobotics.CRMath_rotAboutY)
    __swig_getmethods__["rotAboutZ"] = lambda x: _CoreRobotics.CRMath_rotAboutZ
    if _newclass:
        rotAboutZ = staticmethod(_CoreRobotics.CRMath_rotAboutZ)
    __swig_getmethods__["normL1"] = lambda x: _CoreRobotics.CRMath_normL1
    if _newclass:
        normL1 = staticmethod(_CoreRobotics.CRMath_normL1)
    __swig_getmethods__["normL2"] = lambda x: _CoreRobotics.CRMath_normL2
    if _newclass:
        normL2 = staticmethod(_CoreRobotics.CRMath_normL2)
    __swig_getmethods__["normLinf"] = lambda x: _CoreRobotics.CRMath_normLinf
    if _newclass:
...
_CoreRobotics.CR_EULER_MODE_ZXZ_swigconstant(_CoreRobotics)
CR_EULER_MODE_ZXZ = _CoreRobotics.CR_EULER_MODE_ZXZ

_CoreRobotics.CR_EULER_MODE_XYX_swigconstant(_CoreRobotics)
CR_EULER_MODE_XYX = _CoreRobotics.CR_EULER_MODE_XYX

_CoreRobotics.CR_EULER_MODE_YZY_swigconstant(_CoreRobotics)
CR_EULER_MODE_YZY = _CoreRobotics.CR_EULER_MODE_YZY

_CoreRobotics.CR_EULER_MODE_ZYZ_swigconstant(_CoreRobotics)
CR_EULER_MODE_ZYZ = _CoreRobotics.CR_EULER_MODE_ZYZ

_CoreRobotics.CR_EULER_MODE_XZX_swigconstant(_CoreRobotics)
CR_EULER_MODE_XZX = _CoreRobotics.CR_EULER_MODE_XZX

_CoreRobotics.CR_EULER_MODE_YXY_swigconstant(_CoreRobotics)
CR_EULER_MODE_YXY = _CoreRobotics.CR_EULER_MODE_YXY

_CoreRobotics.CR_EULER_MODE_XYZ_swigconstant(_CoreRobotics)
CR_EULER_MODE_XYZ = _CoreRobotics.CR_EULER_MODE_XYZ

_CoreRobotics.CR_EULER_MODE_YZX_swigconstant(_CoreRobotics)
CR_EULER_MODE_YZX = _CoreRobotics.CR_EULER_MODE_YZX

_CoreRobotics.CR_EULER_MODE_ZXY_swigconstant(_CoreRobotics)
CR_EULER_MODE_ZXY = _CoreRobotics.CR_EULER_MODE_ZXY

_CoreRobotics.CR_EULER_MODE_XZY_swigconstant(_CoreRobotics)
CR_EULER_MODE_XZY = _CoreRobotics.CR_EULER_MODE_XZY

_CoreRobotics.CR_EULER_MODE_ZYX_swigconstant(_CoreRobotics)
CR_EULER_MODE_ZYX = _CoreRobotics.CR_EULER_MODE_ZYX

_CoreRobotics.CR_EULER_MODE_YXZ_swigconstant(_CoreRobotics)
...
_CoreRobotics.CR_EULER_FREE_NONE_swigconstant(_CoreRobotics)
CR_EULER_FREE_NONE = _CoreRobotics.CR_EULER_FREE_NONE

_CoreRobotics.CR_EULER_FREE_POS_X_swigconstant(_CoreRobotics)
CR_EULER_FREE_POS_X = _CoreRobotics.CR_EULER_FREE_POS_X

_CoreRobotics.CR_EULER_FREE_POS_Y_swigconstant(_CoreRobotics)
CR_EULER_FREE_POS_Y = _CoreRobotics.CR_EULER_FREE_POS_Y

_CoreRobotics.CR_EULER_FREE_POS_Z_swigconstant(_CoreRobotics)
CR_EULER_FREE_POS_Z = _CoreRobotics.CR_EULER_FREE_POS_Z

_CoreRobotics.CR_EULER_FREE_ANG_A_swigconstant(_CoreRobotics)
CR_EULER_FREE_ANG_A = _CoreRobotics.CR_EULER_FREE_ANG_A

_CoreRobotics.CR_EULER_FREE_ANG_B_swigconstant(_CoreRobotics)
CR_EULER_FREE_ANG_B = _CoreRobotics.CR_EULER_FREE_ANG_B

_CoreRobotics.CR_EULER_FREE_ANG_G_swigconstant(_CoreRobotics)
...
_CoreRobotics.CR_DH_FREE_NONE_swigconstant(_CoreRobotics)
CR_DH_FREE_NONE = _CoreRobotics.CR_DH_FREE_NONE

_CoreRobotics.CR_DH_FREE_R_swigconstant(_CoreRobotics)
CR_DH_FREE_R = _CoreRobotics.CR_DH_FREE_R

_CoreRobotics.CR_DH_FREE_ALPHA_swigconstant(_CoreRobotics)
CR_DH_FREE_ALPHA = _CoreRobotics.CR_DH_FREE_ALPHA

_CoreRobotics.CR_DH_FREE_D_swigconstant(_CoreRobotics)
CR_DH_FREE_D = _CoreRobotics.CR_DH_FREE_D

_CoreRobotics.CR_DH_FREE_THETA_swigconstant(_CoreRobotics)
CR_DH_FREE_THETA = _CoreRobotics.CR_DH_FREE_THETA

_CoreRobotics.CR_DH_MODE_CLASSIC_swigconstant(_CoreRobotics)
CR_DH_MODE_CLASSIC = _CoreRobotics.CR_DH_MODE_CLASSIC

_CoreRobotics.CR_DH_MODE_MODIFIED_swigconstant(_CoreRobotics)
...
_CoreRobotics.CR_MANIPULATOR_MODE_POSITION_swigconstant(_CoreRobotics)
