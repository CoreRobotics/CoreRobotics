...
/*!
 ...
 \return                Result flag indicating if there is a free
                        value to write
 */
//------------------------------------------------------------------------------
 ...
 */
//------------------------------------------------------------------------------
double Frame::getFreeValue(void) { return 0; }
 ...
 */
//------------------------------------------------------------------------------
Eigen::Matrix4d Frame::getTransformToParent(void) {
  ...
  transform << r(0, 0), r(0, 1), r(0, 2), t(0, 0), r(1, 0), r(1, 1), r(1, 2),
      t(1, 0), r(2, 0), r(2, 1), r(2, 2), t(2, 0), 0.0, 0.0, 0.0, 1.0;
 ...
 */
//------------------------------------------------------------------------------
Eigen::Matrix4d Frame::getTransformToChild(void) {
 ...
 */
//------------------------------------------------------------------------------
Eigen::Vector3d Frame::transformToParent(Eigen::Vector3d i_point) {
 ...
 */
//------------------------------------------------------------------------------
Eigen::Vector3d Frame::transformToChild(Eigen::Vector3d i_point) {
  return m_rotation.transpose() * i_point -
         m_rotation.transpose() * m_translation;
}
 ...
 */
//------------------------------------------------------------------------------
bool Frame::isDriven(void) { return false; }
...
Eigen::Matrix<double, 6, 1> Frame::getPose(EulerMode i_mode) {
  ...
  pose << this->m_translation(0), this->m_translation(1),
      this->m_translation(2), theta(0), theta(1), theta(2);
