...
public:
  ...
  void step() override { PYBIND11_OVERLOAD(void, cr::core::Step, step, ); }

  // Trampoline (need one for each virtual function)
  void onStart() override {
    PYBIND11_OVERLOAD(void, cr::core::Step, onStart, );
  }

  // Trampoline (need one for each virtual function)
  void onStop() override { PYBIND11_OVERLOAD(void, cr::core::Step, onStop, ); }
};
...
void export_py_core(py::module &m) {
  ...
  py::class_<cr::core::StepList, cr::core::StepListPtr, cr::core::Step>(
      m, "StepList")
