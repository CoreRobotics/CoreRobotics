...
void export_py_control(py::module &m) {
  ...
  py::class_<cr::control::KinematicWaypoint>(m, "KinematicWaypoint")
      ...
      .def_readwrite("acceleration",
                     &cr::control::KinematicWaypoint::acceleration)
  ...
  py::class_<cr::control::MinimumJerk::Parameters>(m, "MinimumJerkParameters")
      ...
      .def("solve", (cr::core::Result(cr::control::MinimumJerk::Parameters::*)(
                        const cr::control::KinematicWaypoint &,
                        const cr::control::KinematicWaypoint &)) &
                        cr::control::MinimumJerk::Parameters::solve)
      .def("solve",
           (cr::core::Result(cr::control::MinimumJerk::Parameters::*)(
               const Eigen::VectorXd &, const Eigen::VectorXd &,
               const Eigen::VectorXd &, const Eigen::VectorXd &,
               const Eigen::VectorXd &, const Eigen::VectorXd &, double)) &
               cr::control::MinimumJerk::Parameters::solve);

  py::class_<cr::control::MinimumJerk,
             std::shared_ptr<cr::control::MinimumJerk>>(m, "MinimumJerk")
      .def(py::init())
      .def(py::init<const cr::control::MinimumJerk::Parameters &,
                    const cr::control::KinematicWaypoint &>())
